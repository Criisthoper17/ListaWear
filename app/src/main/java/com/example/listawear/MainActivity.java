...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new ItemsList(R.mipmap.cruzazul, "Cruz Azul", "9 campeonatos"));
        items.add(new ItemsList(R.mipmap.america, "America", "13 campeonatos"));
        items.add(new ItemsList(R.mipmap.monterrey, "Monterrey", "5 campeonatos"));
        items.add(new ItemsList(R.mipmap.atlas_2022, "Atlas", "3 campeonatos"));
        items.add(new ItemsList(R.mipmap.qro, "Querétaro", "0 campeonatos"));
